...
//extern struct cond_t * icmp_mkpkt(qid16) ;
...
extern syscall mutex_init( mutex_t**);
...
extern char *shmat(int16 ,char *, int16);
extern char *shmdt(int16 ,int16);
extern int16 shmget(int16, uint32, int16);
...
#define	ntohl(x)   (  (((x)>>24) & 0x000000ff) | (((x)>> 8) & 0x0000ff00) | (((x)<< 8) & 0x00ff0000) | (((x)<<24) & 0xff000000) )
